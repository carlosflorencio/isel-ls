...
public class GetRentalsByUsernameCommandTest {
    ...
    private Map<MimeType, HttpContent> runCommandAndGetViews() throws CommandFailedException, NoSuchDataException {
        ...
        ICommand cmd = new GetRentalsByUsernameCommand("/users/{username}/rentals");

        IRequest request = TestUtils.getConsoleRequest("GET", "/users/bia/rentals", "");
