...
public class GetRentalsByPropertiesIdCommandTest {
    ...
    private Map<MimeType, HttpContent> runCommandAndGetViews() throws CommandFailedException, NoSuchDataException {
        ...
        ICommand cmd = new GetRentalsByPropertiesIdCommand("/properties/{pid}/rentals");

        IRequest request = TestUtils.getConsoleRequest("GET", "/properties/1/rentals", "");
    ...
    public void testRunWithValidValues() throws Exception{
        ...
        //Text view should have userName = carlos e userName = bia
