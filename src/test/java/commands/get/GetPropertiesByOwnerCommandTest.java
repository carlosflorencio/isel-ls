...
public class GetPropertiesByOwnerCommandTest {
	    ...
	    private Map<MimeType, HttpContent> runCommandAndGetViews() throws CommandFailedException, NoSuchDataException {
	        ICommand cmd = new GetPropertiesByOwnerCommand("/properties/owner/{owner}");

	        IRequest request = TestUtils.getConsoleRequest("GET", "/properties/owner/carlos", "");
