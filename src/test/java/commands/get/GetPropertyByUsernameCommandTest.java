...
public class GetPropertyByUsernameCommandTest {
    ...
    private Map<MimeType, HttpContent> runCommandAndGetViews() throws CommandFailedException, NoSuchDataException {
        ICommand cmd = new GetPropertyByUsernameCommand("/users/{username}/properties/owned");

        IRequest request = TestUtils.getConsoleRequest("GET", "/users/carlos/properties/owned", "");
